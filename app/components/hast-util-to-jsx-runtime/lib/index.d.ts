...
export type RegularFields = {
     ...
     */
    nodeCache?: LRUMap<string, JSX.Element> | null | undefined
    /**
     * Cache for previous nodes.
     */
    parentCache?: LRUMap<string, Nodes> | null | undefined
...
export type RuntimeDevelopment = {
     ...
     * Cache for rendered elements.
     */
    nodeCache?: LRUMap<string, JSX.Element>
    /**
     * Cache for previous nodes.
     */
    parentCache?: LRUMap<string, Nodes>
};
/**
